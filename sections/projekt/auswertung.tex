...
Vergleichen wir diese Spiele mit denen, die Umfrageteilnehmer in Quarantäne am meißten spielten, fallen keine besonderen Abweichungen auf (Abb. \ref{fig:vergleich_quarantaene_spiele}).
...
\begin{figure}
    ...
    \end{tikzpicture}
    \caption{Vergleich beider Umfrage-Fragen}
    \label{fig:vergleich_q_singlemulti}
\end{figure}
